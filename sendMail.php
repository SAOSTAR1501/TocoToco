...
<body>
    ...
    <form method="POST" action="">
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" required="required" value="maicongstar@gmail.com" />
        </div>
        <div class="form-group">
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        try {
            ...
            $nguoigui = 'maicongstar@gmail.com'; // Tài khoản Email
            $matkhau = 'wagj ozzz xrff ptjd'; // Mật khẩu Email
            ...
            $to_name = "Mai Công Sao"; // Tên người cần gửi đến
